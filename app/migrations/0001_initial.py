# Generated by Django 3.1 on 2020-10-05 08:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_type', models.IntegerField(blank=True, choices=[(1, 'Customer'), (2, 'Vendor'), (3, 'Employee'), (4, 'Customer and Vendor')], db_index=True, default=1, null=True)),
                ...
                ('organization_type', models.IntegerField(choices=[(1, 'Individual'), (2, 'Proprietorship'), (4, 'Partnership'), (5, 'Trust'), (6, 'Private Limited'), (7, 'Public Limited'), (8, 'Overseas Organisation'), (9, 'Government Organisation'), (10, 'Others')], db_index=True, default=1)),
                ...
                ('unused_credit', models.CharField(blank=True, db_index=True, default='0.00', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_blank_credit', models.CharField(blank=True, choices=[('off', 'off'), ('on', 'on')], db_index=True, default='off', max_length=4, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customize_name', models.IntegerField(blank=True, choices=[(1, 'Contact'), (2, 'Product'), (3, 'Credit Note'), (4, 'Purhase Order'), (5, 'Invoice'), (6, 'Expense'), (7, 'Purchase Entry'), (8, 'Debit Note')], db_index=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('debit_delivery_address', models.TextField(blank=True, db_index=True, max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('payment_terms', models.IntegerField(blank=True, choices=[(1, 'Due Immediately'), (2, '10 Days'), (3, '20 Days'), (4, '30 Days'), (5, '60 Days'), (6, '90 Days'), (7, 'Custom')], db_index=True, null=True)),
                ('status', models.IntegerField(blank=True, choices=[(0, 'Due'), (1, 'Over Due By'), (2, 'Drafted'), (3, 'Paid'), (4, 'Partially Paid')], db_index=True, null=True)),
                ('expense_date_count', models.IntegerField(blank=True, db_index=True, default=0, null=True)),
                ...
                ('expense_org_gst_num', models.CharField(blank=True, db_index=True, max_length=30, null=True)),
                ('expense_org_gst_type', models.CharField(blank=True, db_index=True, max_length=2, null=True)),
                ('expense_org_gst_state', models.CharField(blank=True, db_index=True, max_length=5, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('vendor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.contacts')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organisation_type', models.IntegerField(choices=[(1, 'Individual'), (2, 'Proprietorship'), (4, 'Partnership'), (5, 'Trust'), (6, 'Private Limited'), (7, 'Public Limited'), (8, 'Overseas Organisation'), (9, 'Government Organisation'), (10, 'Others')], db_index=True, default=1)),
                ...
                ('debit_terms_and_condition', models.CharField(blank=True, db_index=True, max_length=400, null=True)),
                ('debit_note', models.CharField(blank=True, db_index=True, max_length=400, null=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_category', models.IntegerField(blank=True, choices=[(1, 'Raw Material'), (2, 'Finished Goods'), (3, 'Consumable  & Stores” ')], db_index=True, default=0, null=True)),
                ...
                ('hsn_code', models.CharField(blank=True, db_index=True, max_length=10, null=True)),
                ('tds', models.CharField(blank=True, db_index=True, default=0.0, max_length=10, null=True)),
                ('unit', models.IntegerField(blank=True, choices=[(0, 'Box'), (1, 'Cm'), (2, 'Dz'), (3, 'In'), (4, 'G'), (5, 'Ft'), (6, 'Kg'), (7, 'Km'), (8, 'Lb'), (9, 'Mg'), (10, 'M'), (11, 'Pcs')], db_index=True, null=True)),
                ...
                ('selling_tax', models.CharField(blank=True, db_index=True, max_length=10, null=True)),
                ('inclusive_tax', models.CharField(blank=True, db_index=True, max_length=15, null=True)),
                ('sales_account', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('purchase_tax', models.CharField(blank=True, db_index=True, max_length=10, null=True)),
                ...
                ('purchase_account', models.IntegerField(blank=True, db_index=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_balance', models.CharField(blank=True, db_index=True, max_length=20, null=True)),
                ('connect_purchase_order', models.CharField(blank=True, db_index=True, default='NO', max_length=5, null=True)),
                ('cgst', models.CharField(blank=True, db_index=True, max_length=30, null=True)),
                ('sgst', models.CharField(blank=True, db_index=True, max_length=30, null=True)),
                ('igst', models.CharField(blank=True, db_index=True, max_length=30, null=True)),
                ('is_cs_gst', models.BooleanField(blank=True, choices=[(True, 'YES'), (False, 'NO')], db_index=True, default=True, null=True)),
                ...
                ('debit_note', models.IntegerField(blank=True, db_index=True, default=0, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opening_balance', models.CharField(blank=True, db_index=True, default=0.0, max_length=20, null=True)),
                ...
                ('invoice_terms', models.IntegerField(blank=True, choices=[(1, 'Due Immediately'), (2, '10 Days'), (3, '20 Days'), (4, '30 Days'), (5, '60 Days'), (6, '90 Days'), (7, 'Custom')], db_index=True, null=True)),
                ('bills_terms', models.IntegerField(blank=True, choices=[(1, 'Due Immediately'), (2, '10 Days'), (3, '20 Days'), (4, '30 Days'), (5, '60 Days'), (6, '90 Days'), (7, 'Custom')], db_index=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_user', models.BooleanField(choices=[(True, 'YES'), (False, 'NO')], db_index=True, default=False)),
                ('is_organisation', models.BooleanField(choices=[(True, 'YES'), (False, 'NO')], db_index=True, default=False)),
                ('default_bank', models.BooleanField(blank=True, choices=[(True, 'YES'), (False, 'NO')], db_index=True, default=False, null=True)),
                ('account_number', models.CharField(blank=True, db_index=True, max_length=25, null=True)),
                ('account_holder_name', models.CharField(blank=True, db_index=True, max_length=100, null=True)),
                ('ifsc_code', models.CharField(blank=True, db_index=True, max_length=20, null=True)),
                ('bank_name', models.CharField(blank=True, db_index=True, max_length=100, null=True)),
                ('bank_branch_name', models.CharField(blank=True, db_index=True, max_length=100, null=True)),
                ('created_on', models.DateTimeField(auto_now=True, db_index=True, null=True)),
                ('updated_on', models.DateTimeField(db_index=True, null=True)),
                ('contact', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.contacts')),
                ('organisation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.organisations')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_mode', models.IntegerField(blank=True, choices=[(1, 'Cash'), (2, 'Card'), (3, 'Cheque'), (4, 'Demand Draft'), (5, 'Net Banking')], db_index=True, null=True)),
                ('Note', models.CharField(blank=True, db_index=True, max_length=400, null=True)),
                ('attachements', models.FileField(blank=True, db_index=True, null=True, upload_to=app.models.contacts_model.attachments_rename)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_address', models.TextField(blank=True, db_index=True, max_length=500, null=True)),
                ('is_organisation_delivary', models.CharField(choices=[('off', 'off'), ('on', 'on')], db_index=True, default='off', max_length=4)),
                ('is_customer_delivary', models.CharField(choices=[('off', 'off'), ('on', 'on')], db_index=True, default='off', max_length=4)),
                ('customer', models.CharField(blank=True, db_index=True, max_length=10, null=True)),
                ('attention', models.CharField(blank=True, db_index=True, max_length=100, null=True)),
                ...
                ('freight_charges', models.CharField(blank=True, db_index=True, max_length=20, null=True)),
                ('advance', models.CharField(blank=True, db_index=True, max_length=20, null=True)),
                ('order_advance_make_pay', models.CharField(blank=True, choices=[('off', 'off'), ('on', 'on')], db_index=True, default='off', max_length=4, null=True)),
                ('total_balance', models.CharField(blank=True, db_index=True, max_length=20, null=True)),
                ('cgst', models.CharField(blank=True, db_index=True, max_length=30, null=True)),
                ('sgst', models.CharField(blank=True, db_index=True, max_length=30, null=True)),
                ('igst', models.CharField(blank=True, db_index=True, max_length=30, null=True)),
                ...
                ('purchase_org_gst_state', models.CharField(blank=True, db_index=True, max_length=5, null=True)),
                ('purchase_delete_status', models.IntegerField(db_index=True, default=0)),
                ('is_purchase_entry_maked', models.BooleanField(db_index=True, default=False)),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('vendor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.contacts')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_type', models.IntegerField(blank=True, choices=[(1, 'Customer'), (2, 'Vendor'), (3, 'Employee'), (4, 'Customer and Vendor')], db_index=True, default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField(blank=True, db_index=True, max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_recurring_count', models.IntegerField(blank=True, db_index=True, default=0, null=True)),
                ('invoice_recurring_end_date', models.DateField(blank=True, db_index=True, null=True)),
                ('invoice_recurring_repeat', models.IntegerField(blank=True, db_index=True, null=True)),
                ...
                ('invoice_recurring_pay', models.CharField(blank=True, db_index=True, max_length=50, null=True)),
                ...
                ('invoice_status', models.IntegerField(blank=True, choices=[(0, 'Due'), (1, 'Over Due By'), (2, 'Paid')], db_index=True, default=0, null=True)),
                ('inovice_over_due_count', models.IntegerField(blank=True, db_index=True, default=0, null=True)),
                ('terms_and_condition', models.CharField(blank=True, db_index=True, max_length=400, null=True)),
                ('Note', models.CharField(blank=True, db_index=True, max_length=400, null=True)),
                ('attachements', models.FileField(blank=True, db_index=True, null=True, upload_to=app.models.invoice_model.attachments_rename)),
                ('sub_total', models.CharField(blank=True, db_index=True, max_length=20, null=True)),
                ('total_discount', models.CharField(blank=True, db_index=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            name='CustomizePurchaseEntryView',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('entry_number', models.IntegerField(blank=True, choices=[(1, 'YES'), (0, 'NO')], db_index=True, default=0, null=True)),
                ('entry_reference', models.IntegerField(blank=True, choices=[(1, 'YES'), (0, 'NO')], db_index=True, default=0, null=True)),
                ('entry_vendor', models.IntegerField(blank=True, choices=[(1, 'YES'), (0, 'NO')], db_index=True, default=0, null=True)),
                ('entry_date', models.IntegerField(blank=True, choices=[(1, 'YES'), (0, 'NO')], db_index=True, default=0, null=True)),
                ('entry_due_date', models.IntegerField(blank=True, choices=[(1, 'YES'), (0, 'NO')], db_index=True, default=0, null=True)),
                ('entry_advance', models.IntegerField(blank=True, choices=[(1, 'YES'), (0, 'NO')], db_index=True, default=0, null=True)),
                ('entry_total', models.IntegerField(blank=True, choices=[(1, 'YES'), (0, 'NO')], db_index=True, default=0, null=True)),
                ('customize_view_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.customizemodulename')),
            ],
        ),
        migrations.CreateModel(
