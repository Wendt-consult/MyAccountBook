...
function add_header(){
    ...
    if(check.substring(0,check.length-1) != 'invoice_row_header'){
        ...
        html +='<td colspan="5" style="border:1px solid white;"><input class="form-control" id="prduct_header'+invoice_header_number+'" name="id="prduct_header'+invoice_header_number+'"</td>'
        html +='<td colspan="3" style="border-bottom:1px solid white; border-right:1px solid white;"><div class="row"><div class="col-lg-4 col-md-5" style="padding-right:0px;"><font style="color:white;">Sub Total:</font></div><div class="col-lg-8 col-md-7" style="padding-left:0px;margin-top:2%;"><input type="text" class="form-control" id="header_SubTotal'+invoice_header_number+'" name="header_SubTotal[]" readonly></div></div></td>'
        // html +='<td style="border-right:1px solid white"></td>'
        html +='<td style="border-top: none;"><span class="tbclose material-icons" id="'+invoice_header_number+'" name="'+invoice_header_number+'" onclick="header_remove('+invoice_header_number+')" style="cursor: default;">delete_forever</span></td></tr>'
