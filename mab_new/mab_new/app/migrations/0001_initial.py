# Generated by Django 3.0.4 on 2020-05-26 16:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_type', models.IntegerField(choices=[(1, 'Individual'), (2, 'Proprietorship'), (4, 'Partnership'), (5, 'Trust'), (6, 'Government Organisation')], db_index=True, default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pincode', models.CharField(blank=True, db_index=True, max_length=7, null=True)),
                ...
                ('organisation_type', models.IntegerField(choices=[(1, 'Individual'), (2, 'Proprietorship'), (4, 'Partnership'), (5, 'Trust'), (6, 'Government Organisation')], db_index=True, default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('purchase_number', models.CharField(blank=True, db_index=True, max_length=100, null=True)),
                ('purchase_number_check', models.CharField(choices=[('off', 'off'), ('on', 'on')], db_index=True, default='off', max_length=4)),
                ...
                ('contact_number', models.IntegerField(blank=True, db_index=True, null=True)),
                ('terms_and_condition', models.CharField(blank=True, db_index=True, max_length=400, null=True)),
                ('Note', models.CharField(blank=True, db_index=True, max_length=400, null=True)),
                ...
                ('adjustment', models.CharField(blank=True, db_index=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(choices=[(True, 'YES'), (False, 'NO')], db_index=True, default=True)),
                ('major_head', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.MajorHeads')),
