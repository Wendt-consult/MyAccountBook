...
function creditnote_addRow(a) {
    ...
    $(document).on('click','#select2-ItemName'+creditnote_number+'-container',function(){
        ...
        html +='<td style="border:1px solid white;padding-bottom:0%"><select class="form-control select credit_note_item" id="ItemName'+creditnote_number+'" name="ItemName[]" onchange="product('+creditnote_number+'),validation()" style="padding-left:0px"><option value="-------">-------</option></select>'
        html +='<textarea id="desc'+creditnote_number+'" name="desc[]" rows="2" maxlength="200"  size="200" placeholder="Product Describtion" style="width: 213.6px;margin-top:1px;"></textarea></td>'
        html +='<td style="border:1px solid white;"><input type="text" class="form-control" id="type'+creditnote_number+'" name="type[]" readonly></td>'
        ...
        html +='<td style="border:1px solid white;"><input class="form-control" onchange="validation()" id="Unit'+creditnote_number+'" name="Unit[]" style="padding-left:0px;" readonly></td>'
        html +='<td style="border:1px solid white;"><input type="text" class="form-control" id="Quantity'+creditnote_number+'" onkeypress="return restrictAlphabets(event), float_value(event,\'Quantity'+creditnote_number+'\')" onkeyup="creditnote_calculate('+creditnote_number+'), validation()" name="Quantity[]"></td>'
