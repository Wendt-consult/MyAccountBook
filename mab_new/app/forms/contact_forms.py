...
class ContactsForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'email': TextInput(attrs={'class':'form-control input-sm', 'placeholder':'abc@gmail.com','style':'padding-left: 9px;', 'onkeyup':'setMessage($(this))', 'onfocusout':'valid_Email($(this))' }),
            ...
            'contact_name' : TextInput(attrs={'class':'form-control input-sm','placeholder':'First Name      Middle Name      Last Name', 'max_length':'200','style':'padding-left: 9px;',}),
            ...
            'organization_name' : TextInput(attrs={'class':'form-control input-sm', 'max_length':'200','style':'padding-left: 9px;',}),
...
class AddressForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'city' : TextInput(attrs={'class':'form-control input-sm','required':True,'style':'width:40%;'}),
            'state' : Select(attrs={'class':'form-control input-sm','required':True,'style':'width:40%;'}, choices = country_list.STATE_LIST_CHOICES),
            'country' : Select(attrs={'class':'form-control input-sm','required':True,'style':'width:40%;'}, choices = country_list.COUNTRIES_LIST_CHOICES),
...
class EditAddressForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'city' : TextInput(attrs={'class':'form-control input-sm ','required':True,'style':'width:50%;'}),
            'state' : Select(attrs={'class':'form-control input-sm state_select ','required':True,'style':'width:50%;'}, choices = country_list.STATE_LIST_CHOICES),
            'country' : Select(attrs={'class':'form-control input-sm ','required':True,'style':'width:50%;'}, choices = country_list.COUNTRIES_LIST_CHOICES),
...
class ContactsExtraForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'website': TextInput(attrs={'class':'form-control input-sm','style':'padding-left:9px','placeholder':'http://google.com/', 'onkeyup':'setMessage($(this))', 'onfocusout':'valid_URL($(this))'}),
